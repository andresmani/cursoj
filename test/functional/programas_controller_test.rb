...
class ProgramasControllerTest < ActionController::TestCase
  ...
  test "should create programa" do
    assert_difference('Programa.count') do
      post :create, programa: { nombre: @programa.nombre, observaciones: @programa.observaciones, precio: @programa.precio }
    end
  ...
  test "should update programa" do
    put :update, id: @programa, programa: { nombre: @programa.nombre, observaciones: @programa.observaciones, precio: @programa.precio }
    assert_redirected_to programa_path(assigns(:programa))
  end
